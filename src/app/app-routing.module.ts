...
const routes: Routes = [
  ...
  { path: 'milk-sales-edit/:milkSaleId', loadChildren: './pages/sales/milk-sales/milk-sales-edit/milk-sales-edit.module#MilkSalesEditPageModule', canActivate: [AuthGuardService] },
  { path: 'other-sales-edit/:otherSaleId', loadChildren: './pages/sales/other-sales/other-sales-edit/other-sales-edit.module#OtherSalesEditPageModule', canActivate: [AuthGuardService] },
